...
from robots.unitree import G129_CFG_WITH_DEX1_BASE_FIX,G129_CFG_WITH_DEX3_BASE_FIX,G129_CFG_WITH_INSPIRE_HAND,G129_CFG_WITH_DEX1_WHOLEBODY,G129_CFG_WITH_DEX1_WHOLEBODY_NAV,G129_CFG_WITH_DEX3_WHOLEBODY,G129_CFG_WITH_INSPIRE_WHOLEBODY,H12_CFG_WITH_INSPIRE_HAND
...
class G1RobotPresets:
    ...
    @classmethod
    def g1_29dof_dex1_wholebody_nav(cls,init_pos: Tuple[float, float, float] = (-0.15, 0.0, 0.80),
        init_rot: Tuple[float, float, float, float] = (0.7071, 0, 0, 0.7071)) -> ArticulationCfg:
        """Navigation task configuration with the package-owned head depth camera USD."""
        return RobotBaseCfg.get_base_config(
            init_pos=init_pos,
            init_rot=init_rot,
            include_waist=True,
            is_have_hand=False,
            base_config=G129_CFG_WITH_DEX1_WHOLEBODY_NAV,
            update_default_joint_pos=False )
    @classmethod
